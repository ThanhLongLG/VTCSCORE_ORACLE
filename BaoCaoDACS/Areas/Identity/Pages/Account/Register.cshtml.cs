...
namespace BaoCaoDACS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            AppDbContext context) // Thêm tham số này
        {
            ...
            _context = context; // Lưu tham chiếu đến context
        }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var participant = new BaoCaoDACS.Models.Participant
                    {
                        ...
                        Club = "Default Club" // Có thể thêm trường Club vào form đăng ký nếu muốn
                    };

                    // Lưu Participant vào database
                    // Cần inject DbContext vào constructor
